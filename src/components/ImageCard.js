  ...
  return (
    <div className='w-60 h-auto m-4 bg-gray-100 shadow-md p-2'>
      ...
      <div>
        ...
        <span className='font-bold text-sm px-3 py-1 mx-1 my-2 bg-green-100'>#{strarray[0]}</span>
        <span className='font-bold text-sm px-3 py-2 mx-1 my-2 bg-green-100'>#{strarray[1]}</span>
        <span className='font-bold text-sm px-3 py-2 mx-1 my-2 bg-green-100'>#{strarray[2]}</span>
        </div>
      </div>
